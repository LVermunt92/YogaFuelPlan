...
function MealPlannerMain() {
  ...
  // Ref for scrolling to generate section
              ...
              <div className="bg-white rounded-lg shadow-md p-8 border border-gray-200">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700 pt-1">{t.emptyStateStep1}</p>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700 pt-1">{t.emptyStateStep2}</p>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700 pt-1">{t.emptyStateStep3}</p>
                  </div>
                </div>
                ...
                <div className="text-center">
                  <Button
                    onClick={() => {
                      ...
                      const isProfileComplete = userProfile?.weight && userProfile?.height && userProfile?.age && userProfile?.activityLevel;
                      
                      if (!isProfileComplete) {
                        // Redirect to profile page
                        setLocation('/profile');
                        toast({
                          title: t.completeProfileFirst,
                          variant: "default",
                        });
                      } else {
                        // Scroll to generate meal plan section
                    ...
                    data-testid="button-generate-first-meal-plan"
                  >
                    <Utensils className="mr-2 h-5 w-5" />
                    {profileLoading ? t.loading : t.generateFirstMealPlan}
                  </Button>
                </div>
              </div>
            </div>
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-white">
            ...
            {loadingRecipe ? (
              ...
              <div className="space-y-6">
                ...
                {/* Nutrition Information Dropdown */}
                <Collapsible open={nutritionOpen} onOpenChange={setNutritionOpen}>
                  <CollapsibleTrigger className="w-full">
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                      <div className="flex items-center gap-2">
                        <Activity className="w-4 h-4 text-gray-600" />
                        <span className="text-sm font-medium text-gray-700">{t.nutritionInfo || 'Nutrition information'}</span>
                        <span className="text-xs text-gray-500 italic">({t.perServing || 'per serving'})</span>
                      </div>
                      <ChevronDown className={`w-4 h-4 text-gray-500 transition-transform ${nutritionOpen ? 'rotate-180' : ''}`} />
                    </div>
                  </CollapsibleTrigger>
                  <CollapsibleContent>
