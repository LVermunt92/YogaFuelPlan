            ...
            <div className="mb-6 relative">
              ...
              <div className="text-center relative">
                ...
                <div className="flex items-center justify-center gap-1">
                  ...
                  <Dialog>
                    <DialogTrigger asChild>
                      <button className="text-gray-600/60 hover:text-gray-600" data-testid="info-cocoa">
                        <Info className="h-3 w-3" />
                      </button>
                    </DialogTrigger>
                    <DialogContent className="max-w-sm">
                      <DialogHeader>
                        ...
                        <DialogDescription className="text-sm pt-2">
                          ...
                          <p className="text-xs text-purple-600 font-medium mt-2">{t.cocoaFlavanolsTarget}</p>
                        </DialogDescription>
                      </DialogHeader>
                    </DialogContent>
                  </Dialog>
