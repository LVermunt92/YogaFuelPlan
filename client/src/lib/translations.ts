export const translations = {
  en: {
    ...
    cookingDaysHelp: "How many cooking sessions per week (each session makes dinner + next day's lunch)",
  ...
  nl: {
    ...
    cookingDaysHelp: "Hoeveel kooksessies per week (elke sessie maakt avondeten + lunch van de volgende dag)",
