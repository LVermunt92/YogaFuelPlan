export const translations = {
  en: {
    ...
    cookingDaysHelp: "Set lower than eating days for meal prep mode (separate lunch & dinner prep cycles)",
  ...
  nl: {
    ...
    cookingDaysHelp: "Stel lager in dan eetdagen voor meal prep modus (aparte lunch & diner bereidingscycli)",
