export const translations = {
  en: {
    ...
    eveningPrepOverview: "Evening prep",
    ...
    sleepLabel: "sleep",
    clickToViewDetails: "Click on a meal plan to view its details",
    itemsChecked: "items checked",
    ofItems: "of",
    noMealPlanSelected: "No meal plan selected",
    recipeLoadingFailed: "Recipe loading failed",
    unableToLoadRecipe: "Unable to load recipe details",
    rainbow: "Rainbow",
    netCarbs: "Net carbs",
    colorLegend: "Color legend:",
    freshCookingLabel: "Fresh cooking",
    leftoversLabel: "Leftovers",
    eatingOutLabel: "Eating out",
    addedIngredientsLabel: "Added ingredients",
    usedLeftovers: "Used leftovers:",
    ingredientsIncorporated: "These ingredients are incorporated in recipes marked with the + icon",
    stillToUse: "Still to use:",
    weekendMealPrep: "Weekend meal prep",
    weekendMealPrepTooltip: "Prepare components of your weekday meals this weekend",
    onLabel: "On",
    offLabel: "Off",
    ingredientsToUseUpTooltip: "Got ingredients in your fridge that need to be used up? Add them here and we'll make sure they're included in next week's meals.",
    ingredientsToUsePlaceholder: "e.g. leftover spinach, aging mushrooms...",
    ingredientsToUseList: "Ingredients to use up:",
    ingredientsIncorporatedTooltip: "These ingredients are incorporated in recipes marked with the + icon",
    betterOrganic: "Better organic",
    ultraProcessed: "Ultra-processed",
    ultraProcessedFood: "Ultra-processed food",
    generated: "Generated",
    day: "Day",
    chives: "Chives",
  ...
  nl: {
    ...
    saturatedFat: "Verz. vet",
    unsaturatedFat: "Onverz. vet",
    nutritionInfo: "Voedingswaarden",
    perServing: "per portie",
    vitaminK: "Vitamine K1",
    vitaminK2: "Vitamine K2",
    potassium: "Kalium",
    calcium: "Calcium",
    iron: "IJzer",
    vitaminC: "Vitamine C",
    ...
    // Meal prep overview
    mealPrepOverview: "Weekend maaltijdbereiding",
    eveningPrepOverview: "Avondbereiding",
    ...
    sleepLabel: "slaap",
    clickToViewDetails: "Klik op een maaltijdplan om de details te bekijken",
    itemsChecked: "items afgevinkt",
    ofItems: "van",
    noMealPlanSelected: "Geen maaltijdplan geselecteerd",
    recipeLoadingFailed: "Recept laden mislukt",
    unableToLoadRecipe: "Kan receptdetails niet laden",
    rainbow: "Regenboog",
    netCarbs: "Netto koolh.",
    colorLegend: "Kleurlegende:",
    freshCookingLabel: "Vers koken",
    leftoversLabel: "Restjes",
    eatingOutLabel: "Uit eten",
    addedIngredientsLabel: "Extra ingrediënten",
    usedLeftovers: "Gebruikte restjes:",
    ingredientsIncorporated: "Deze ingrediënten zijn verwerkt in recepten gemarkeerd met het + icoon",
    stillToUse: "Nog te gebruiken:",
    weekendMealPrep: "Weekend maaltijdbereiding",
    weekendMealPrepTooltip: "Bereid componenten van je weekmaaltijden dit weekend voor",
    onLabel: "Aan",
    offLabel: "Uit",
    ingredientsToUseUpTooltip: "Heb je ingrediënten in je koelkast die op moeten? Voeg ze hier toe en we zorgen dat ze worden gebruikt in de maaltijden van volgende week.",
    ingredientsToUsePlaceholder: "bijv. restje spinazie, oude champignons...",
    ingredientsToUseList: "Ingrediënten om op te maken:",
    ingredientsIncorporatedTooltip: "Deze ingrediënten zijn verwerkt in recepten gemarkeerd met het + icoon",
    betterOrganic: "Beter biologisch",
    ultraProcessed: "Ultra-bewerkt",
    ultraProcessedFood: "Ultra-bewerkt voedsel",
