...
Balanced Recipe Variety Management: Fixed repetitive "Marry Me" recipe issue by implementing intelligent variety management with equal treatment for viral and regular recipes. System now ensures only one "Marry Me" recipe per meal plan through enhanced similarity filtering. Viral recipes remain relevant through periodic updates but don't receive selection priority over regular recipes, ensuring natural variety distribution. All recipe names cleaned of viral indicators - no more "(TikTok Sensation)" or "(Social Media Hit)" suffixes in recipe titles.
