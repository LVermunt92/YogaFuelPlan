...
function applyTDEEBasedPortionAdjustment(meals: InsertMeal[], user: User | undefined): InsertMeal[] {
  ...
  return meals.map(meal => ({
    ...
    saturatedFat: Math.round(((meal as any).saturatedFat || 0) * cappedFactor * 10) / 10,
    ...
    vitaminK2: Math.round(((meal as any).vitaminK2 || 0) * cappedFactor),
  ...
  for (let day = 1; day <= 7; day++) {
    ...
    for (const mealCategory of mealsToGenerate) {
      ...
      const meal: InsertMeal = {
        ...
        saturatedFat: Math.round(((selectedMeal.nutrition as any).saturatedFat || 0) * portionMultiplier * 10) / 10,
        ...
        vitaminK2: Math.round(((selectedMeal.nutrition as any).vitaminK2 || 0) * portionMultiplier),
    ...
    if (day !== 1) {
      ...
      if (selectedBreakfast) {
        ...
        meals.push({
          ...
          saturatedFat: Math.round(((selectedBreakfast.nutrition as any).saturatedFat || 0) * portionFactor * 10) / 10,
          ...
          vitaminK2: Math.round(((selectedBreakfast.nutrition as any).vitaminK2 || 0) * portionFactor),
    ...
    if (daysWithMeals.includes(day)) {
      ...
      if (lunchMeal) {
        ...
        meals.push({
          ...
          saturatedFat: Math.round(((lunchMeal.nutrition as any).saturatedFat || 0) * portionFactor * 10) / 10,
          ...
          vitaminK2: Math.round(((lunchMeal.nutrition as any).vitaminK2 || 0) * portionFactor),
      ...
      if (dinnerMeal) {
        ...
        meals.push({
          ...
          saturatedFat: Math.round(((dinnerMeal.nutrition as any).saturatedFat || 0) * portionFactor * 10) / 10,
          ...
          vitaminK2: Math.round(((dinnerMeal.nutrition as any).vitaminK2 || 0) * portionFactor),
    ...
    if (snackPool.length > 0) {
      ...
      for (let day = 2; day <= 7; day++) {
        ...
        adjustedMeals.push({
          ...
          saturatedFat: Math.round(((snackNutrition as any).saturatedFat || 0) * 10) / 10,
