...
export const ENHANCED_MEAL_DATABASE: MealOption[] = [
  ...
  },
  {
    ...
    portion: "1 portion (3 eggs + vegetables)",
    nutrition: { 
      protein: 24, 
      prepTime: 15, 
      calories: 380,
  ...
  // Lunch options - Whole Foods Focus
  {
    ...
    portion: "2 portions (lentils + vegetables)",
    nutrition: { 
      protein: 24, 
      prepTime: 35, 
      calories: 420,
  ...
  },
  {
    ...
    portion: "2 portions (quinoa + vegetables)",
    nutrition: { 
      protein: 18, 
      prepTime: 35, 
      calories: 340,
  ...
  // Quick weekday dinner options for complex dietary restrictions
  {
    ...
    portion: "2 portions (noodles + vegetables)",
    nutrition: { 
      protein: 18, 
      prepTime: 20, 
      calories: 420,
...

  {
    ...
    portion: "2 portions (curry + quinoa)",
    nutrition: { 
      protein: 22, 
      prepTime: 25, 
      calories: 480,
...

  {
    ...
    portion: "2 portions (quinoa bowl)",
    nutrition: { 
      protein: 16, 
      prepTime: 30, 
      calories: 440,
  ...
  // Quick Ayurvedic lunch and dinner options
  {
    ...
    portion: "2 portions (dal with rice)",
    nutrition: { 
      protein: 22, 
      prepTime: 25, 
      calories: 380,
