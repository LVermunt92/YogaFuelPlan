...
export function generateEnhancedShoppingList(meals: { foodDescription: string }[], language: string = 'en', dietaryTags: string[] = []): ShoppingListItem[] {
  ...
  const ingredientCategories: Record<string, string> = {
    ...
    'gluten-free oats': 'Dry Goods',
    'gluten-free pasta': 'Dry Goods',
    'gluten-free tortilla': 'Dry Goods',
    'chickpea flour': 'Dry Goods',
    'coconut flour': 'Dry Goods',
    'sweet potato': 'Vegetables',
    'sweet potatoes': 'Vegetables',
    'gluten-free granola': 'Dry Goods',
    'red lentils': 'Dry Goods',
    'green lentils': 'Dry Goods',
    'lentils': 'Dry Goods',
    'chickpeas': 'Dry Goods',
    'black beans': 'Dry Goods',
    'white beans': 'Dry Goods',
    'kidney beans': 'Dry Goods',
    'mung beans': 'Dry Goods',
    'edamame': 'Dry Goods',
    'pea protein powder': 'Dry Goods',
    'vanilla protein powder': 'Dry Goods',
    'plant protein powder': 'Dry Goods',
    'almond butter': 'Dry Goods',
    'chia seeds': 'Dry Goods',
    'hemp hearts': 'Dry Goods',
    'hemp seeds': 'Dry Goods',
    'flax seeds': 'Dry Goods',
    'mixed nuts': 'Dry Goods',
    'almonds': 'Dry Goods',
    'walnuts': 'Dry Goods',
    'sunflower seeds': 'Dry Goods',
    ...
    'fennel powder': 'Dry Goods',
    'garlic powder': 'Dry Goods',
    'onion powder': 'Dry Goods',
    'paprika': 'Dry Goods',
    'cumin': 'Dry Goods',
    'ground coriander': 'Dry Goods',
    'turmeric': 'Dry Goods',
    'curry powder': 'Dry Goods',
    'garam masala': 'Dry Goods',
    'smoked paprika': 'Dry Goods',
    'cayenne pepper': 'Dry Goods',
    'red pepper flakes': 'Dry Goods',
    'chili flakes': 'Dry Goods',
    'dried oregano': 'Dry Goods',
    'dried basil': 'Dry Goods',
    'dried thyme': 'Dry Goods',
    'bay leaves': 'Dry Goods',
