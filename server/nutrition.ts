...
export const MEAL_DATABASE: MealOption[] = [
  ...
  // Dinner options
  {
    ...
    ingredients: ["extra firm tofu", "edamame", "quinoa", "broccoli", "bell peppers", "sugar snaps", "carrots", "ginger", "garlic", "soy sauce", "sesame oil"],
    vegetableContent: {
      servings: 5,
      vegetables: ["broccoli", "bell peppers", "sugar snaps", "carrots", "edamame"],
    ...
    recipe: {
      instructions: [
        ...
        "Add bell pepper strips and sugar snaps, stir-fry 2 minutes",
